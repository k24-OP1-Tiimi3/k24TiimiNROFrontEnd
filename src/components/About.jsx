export default function About() {
    return (
        <>
            ...
            <p>
                Dog Store was created to deliver high-quality, functional, comfortable pet essentials at accessible prices.
                <br />
                <br />
                Hello fellow dog parents! We're not the typical pet industry veterans, our journey with Dog Store began in 2017 with a simple problem: finding quality yet affordable clothes for our Frenchie Stella was mission impossible. That was our 'aha!' moment- there is a serious need for quality dog gear that doesn't cost an arm and a leg!
